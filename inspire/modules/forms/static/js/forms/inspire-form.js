...
define(function(require, exports, module) {
    ...
    var $ = require('jquery'),
        ...
        tpl_file_entry = require('hgn!js/deposit/templates/file_entry'),
        tpl_file_link = require('hgn!js/deposit/templates/file_link'),
        tpl_flash_message = require('hgn!js/deposit/templates/flash_message'),
        tpl_field_message = require('hgn!js/deposit/templates/field_message'),
        tpl_status_saving = require('hgn!js/deposit/templates/status_saving'),
        tpl_status_error = require('hgn!js/deposit/templates/status_error'),
        tpl_status_saved = require('hgn!js/deposit/templates/status_saved'),
        tpl_status_saved_with_error = require('hgn!js/deposit/templates/status_saved_with_error'),
        tpl_success = require('hgn!js/deposit/templates/success'),
        tpl_loader = require('hgn!js/deposit/templates/loader'),
        tpl_loader_success = require('hgn!js/deposit/templates/loader_success'),
  ...
  this.preventFormSubmit = function(ev, data) {
    $(this.attr.formSelector).find("input").bind("keyup keypress", function(e) {
